    ...
    return (
        ...
        >
            ...
            <div className='flex items-center gap-10 p-8 hover:p-7.5 hover:m-0.5 transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
                <div className='bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center'>
                    {typeof service.icon === 'string' ? (
                        ...
                        <div className='w-16 h-16 bg-white dark:bg-gray-900 rounded-full m-2 flex items-center justify-center text-primary'>
                            {service.icon}
                        </div>
                    )}
                </div>
